...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=9,da_board_cnt=5,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [3:0]axi_gpio_btns_gpio_io_o;
  wire [3:0]axi_gpio_sws_gpio_io_o;
  wire [3:0]axi_gpio_time_ew_gpio_io_o;
  wire [3:0]axi_gpio_time_ns_gpio_io_o;
  ...
  design_1_axi_gpio_1_0 axi_gpio_btns
       (.gpio_io_o(axi_gpio_btns_gpio_io_o),
  ...
  design_1_axi_gpio_0_1 axi_gpio_sws
       (.gpio_io_o(axi_gpio_sws_gpio_io_o),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  design_1_axi_gpio_0_3 axi_gpio_time_ew
       (.gpio_io_o(axi_gpio_time_ew_gpio_io_o),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  design_1_axi_gpio_0_2 axi_gpio_time_ns
       (.gpio_io_o(axi_gpio_time_ns_gpio_io_o),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  design_1_semafor_0_0 semafor_0
       (.btn(axi_gpio_btns_gpio_io_o),
        .clk(processing_system7_0_FCLK_CLK0),
        .green_ew_i(axi_gpio_time_ew_gpio_io_o),
        .green_ns_i(axi_gpio_time_ns_gpio_io_o),
        .led_out(semafor_0_led_out),
        .rst(rst_ps7_0_50M_peripheral_reset),
        .sw(axi_gpio_sws_gpio_io_o));
